...
// Help decode JWT token from Google
...
const Login = () => {
    ...
    // Reverting to Official Google Login (GSI)
    useEffect(() => {
        /* global google */
        if (typeof google !== 'undefined') {
            google.accounts.id.initialize({
                client_id: "YOUR_GOOGLE_CLIENT_ID.apps.googleusercontent.com", // MANDATORY: Change this to your real Client ID
        ...
        <div className="auth-container premium-dark">
            <div className="auth-card glassmorphism animate-fade-in">
                ...
                <form onSubmit={handleSubmit} className="auth-form">
                    ...
                    <div className="divider"><span>OR SIGN IN WITH GOOGLE</span></div>
            ...
            <style>{`
                ...
                #googleBtn iframe { margin: 0 auto; }
            `}</style>
        </div>
    );
};
