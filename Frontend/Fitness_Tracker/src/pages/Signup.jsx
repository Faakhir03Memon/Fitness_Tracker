...
import { UserPlus, Mail, Lock, User, Search, Github, ArrowRight } from 'lucide-react';
        ...
        <div className="auth-container premium-dark">
            <div className="auth-card glassmorphism animate-fade-in">
                <div className="auth-header">
                    ...
                    <h2 className="bebas-font">CREATE ACCOUNT</h2>
                    <p className="auth-subtitle">Join the elite community and track your transformation</p>
                </div>
